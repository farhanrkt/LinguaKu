...
| | Check | Expected |
|---|---|---|
| 0.1 | `package.json` version | **`1.13.0`** |
...
| 1.3 | Unit tests | **798 passed, 58 files**, ~7 s. Zero skipped. |
...
| 1.7 | Initial JS | **140.8 KB / 200 KB gzipped (70%)** — invariant 6. |
...
| | Check | Expected |
|---|---|---|
| 2.1 | Full suite | **61 passed**, emulated Pixel 5 / android-chrome, ~96 s. |
