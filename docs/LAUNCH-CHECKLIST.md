...
| | Check | Expected |
|---|---|---|
| 0.1 | `package.json` version | **`1.12.1`** |
...
| 1.3 | Unit tests | **786 passed, 57 files**, ~7 s. Zero skipped. |
...
| 1.7 | Initial JS | **140.0 KB / 200 KB gzipped (70%)** — invariant 6. |
...
| | Check | Expected |
|---|---|---|
| 2.1 | Full suite | **59 passed**, emulated Pixel 5 / android-chrome, ~96 s. |
